...
import { Center, ScrollView, VStack, Text, Skeleton, Heading, useToast, useTheme } from 'native-base';
...
export function Profile() {
  ...
  const [userPhoto, setUserPhoto] = useState('https://github.com/marcus-feitosa.png');
